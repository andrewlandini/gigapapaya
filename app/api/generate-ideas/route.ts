...
const nextStepSchema = z.object({
  ...
  })).min(6).max(6).describe('6 unique, creative answer options with pre-generated reactions'),
});
...
Generate 6 answer options. Rules:
...
- Cover a range of genres — comedy, drama, thriller, absurd, heartfelt, surreal
