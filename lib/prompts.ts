...
4. **Dialogue**: If the scene has people, they should almost always be talking. Write dialogue as SPOKEN WORDS — conversational, not literary. Use contractions, natural filler, let people trail off. Match dialogue to mood. Dialogue across scenes should feel like one continuous conversation.
CRITICAL WORD COUNT: People speak ~2.5 words/second. COUNT YOUR DIALOGUE WORDS. For an 8-second scene, dialogue must be MAX 15-18 words total (leaves room for pauses/breathing). For 6 seconds, MAX 12 words. For 4 seconds, MAX 8 words. If your dialogue exceeds this limit, the video WILL cut off mid-sentence. One short punchy line is always better than a paragraph. Example for 8s: "So picture this, we line the hallway with lawyers' cards" (11 words = perfect). NOT a 47-word monologue.
